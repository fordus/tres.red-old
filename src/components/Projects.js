  ...
  const projects = [
    {
      ...
      tags: ['react', 'css', 'js', 'K8s', 'AWS'],
      link: 'https://github.com/fordus',
      stars: '50'
    },
    {
      thumbnail: null,
      ...
      <section id='addons-content' className='page-section'>
        <div className='card-container'>
          {projects.map((project, index) => (
            <a className='card-wrap' href={project.link} target='_blank' rel='noopener noreferrer' key={index}>
              <div className='card'>
